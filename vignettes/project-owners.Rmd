...
- Edit your [`.Renviron`](https://csgillespie.github.io/efficientR/3-3-r-startup.html#renviron) file:
    ...
    - `FORECAST_JSON_FILE`: the path of a forecast data file in the format documented in
...
upload_file_job_id <- upload_forecast(conn, model_id, timezero_date_str, forecast_json_file)
