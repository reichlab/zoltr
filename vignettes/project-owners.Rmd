...
```{r}
project_config <- jsonlite::read_json("data/docs-project.json")  # "name": "My project"
...
Finally, get the new forecast's URL from the `UploadFileJob` object and then call the `forecasts()` function to get a
...
the_forecasts <- forecasts(zoltar_connection, the_forecast_info$forecast_model)
str(the_forecasts)
```
