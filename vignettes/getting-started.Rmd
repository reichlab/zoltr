...
## Finally, download the first forecast's data

You can get forecast data using the `download_forecast()` function, which supports a nested `list` format. (Please see
[here](https://www.zoltardata.com/docs#forecast-data-format) for forecast format details.) 
