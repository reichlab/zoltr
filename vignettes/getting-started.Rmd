---
title: "Getting Started with zoltr"
author: "Matthew Cornell"
date: "2019-05-13"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with zoltr}
...
# Welcome to _Getting Started with zoltr_

Welcome to the zoltr _Getting Started_ vignette. zoltr is an R package that simplifies access to the 
[zoltardata.com](https://www.zoltardata.com/) API. This vignette takes you through the package's main features. So that
you can experiment without needing a Zoltar account, we use our "flagship" project for the CDC Flu challenge, which 
should always be available for public read-only access.
...
(Note: To access protected resources, you need to call the `z_authenticate()` function before calling any zoltr
...
the_models <- models(conn, project_id)  # may take some time due to the number of models and a Zoltar performance issue
str(the_models)
```


## Get a model to work with, and list its info and forecasts (if any)
