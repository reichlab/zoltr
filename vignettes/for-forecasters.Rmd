---
title: "zoltr for Forecasters"
author: "Matthew Cornell"
date: "2019-05-13"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{zoltr for Forecasters}
...
# Welcome to _zoltr for Forecasters_
Welcome to the zoltr vignette for forecasters. You should read this if you are interested in creating and managing your
own [zoltardata.com](https://www.zoltardata.com/) projects using this package to access them via the Zoltar API.
Building on the _Getting Started_ vignette, this one covers deleting and uploading forecasts. Note that before starting
you should:
...
To access your project, you'll first need to authenticate via the `z_authenticate()` function. Pass it the username and 
password for your account. Note that currently Zoltar uses a five minute timeout on the underlying JWT tokens used under 
the hood, which means you'll have to re-authenticate after that time.
